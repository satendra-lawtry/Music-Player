...
from adminside import views as adminap

urlpatterns = [
    # path('', views.home),
    path('admin-panel', adminap.adminprofile,name='adminprofile'),
    ...
    # path('account/profile/', auth_views.LoginView.as_view(template_name='app/profile.html'),name='profile'),
